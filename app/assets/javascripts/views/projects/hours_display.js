Freelancer.Views.HoursDisplay = Backbone.View.extend({
  ...
  initialize: function() {
    this.listenTo(this.model, 'change:uninvoiced_hours_count', this.render);
  },
  template: JST['projects/hours_display'],
  
  render: function() {
    var disabled = this.model.escape('uninvoiced_hours_count') && this.model.escape('uninvoiced_hours_count') < 1
